...
**Audit Report**: [View Report (PDF)](https://hashlock.com/wp-content/uploads/2026/02/Cartha-Smart-Contract-Audit-Report-Final-Report-v5.pdf)

**Audit Page**: [https://hashlock.com/audits/cartha](https://hashlock.com/audits/cartha)
...
If you discover a potential security issue, please contact the team through the official channels listed on the [Contact page](../contact.md).

***

> **Disclaimer**: While smart contracts have been audited, all DeFi protocols carry inherent risks. Users should understand these risks before participating. See [Legal & Risk](../legal-and-risk.md) for more information.
