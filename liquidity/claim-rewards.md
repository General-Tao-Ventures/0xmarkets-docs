...
<!-- TBD: confirm/replace hosted video URL — current asset path uses the old bucket name and may need re-hosting under a 0xMarkets path -->

[▶ Watch the claim-rewards walkthrough](https://storage.googleapis.com/cartha-public/assets/Cartha-claim-rewards-with-GTV.mp4)

---

## Steps

> **Tip**: From the [My Positions](https://liquidity.0xmarkets.io/positions) page, click **"View Miner Page"** on any federated position to jump directly to your principal miner's dashboard — no need to browse the list.
...
1. Go to [liquidity.0xmarkets.io/principal-miners](https://liquidity.0xmarkets.io/principal-miners) and pick your principal miner (e.g. **General Tensor**)
