...
Withdrawing from the 0xMarkets Liquidity Engine returns your locked USDC principal (plus any accrued vault value) to your connected EVM wallet. Withdrawal is only available after **both** conditions are met:
...
> The 0xMarkets liquidity vaults provide real DEX liquidity. LP positions can experience losses in volatile markets. See [Liquidations](../trading/liquidations.md) and [Risk disclosures](../security/risk-disclosures.md) for details.
...
- **[Liquidations](../trading/liquidations.md)** and **[Risk disclosures](../security/risk-disclosures.md)** — Learn about vault risk and LP liquidations
